...
<body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
            ...
            <nav class="flex items-center justify-between gap-4">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}" class="shrink-0 flex items-center">
                        ...
                        <p class="px-3 text-lg font-bold">Sentiment <span class="text-indigo-600">Detection</span></p>
                    </a>
                </div>
                @auth
    ...
    <div class="flex items-center justify-center w-full min-h-screen from-indigo-50 via-white to-indigo-100">
        <main class="max-w-5xl w-full px-6 py-16 text-center">
            {{-- Hero Section --}}
            <h1 class="text-4xl sm:text-6xl font-extrabold text-gray-900 leading-tight">
                Voice Sentiment <span class="text-indigo-600">Analysis</span>
            </h1>
            <p class="mt-6 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Upload an audio file and let our system detect the underlying emotions in real time.
            </p>

            {{-- CTA Button --}}
            <div class="mt-8">
                <a href="{{ route('login') }}"
                    class="inline-block px-8 py-4 bg-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:bg-indigo-700 transition">
                    Get Started
                </a>
            </div>
            ...
            <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-indigo-600 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-auto" fill="none"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 19V6h13M9 6l-2 2m2-2l2 2" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900">Upload Your Voice</h3>
                    <p class="mt-2 text-gray-600 text-sm">
                        Easily upload audio in MP3 or WAV format through a simple interface.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-md p-6">
                    <div class="text-indigo-600 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-auto" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c.132 0 .263.009.392.026a4 4 0 100 7.948A7.5 7.5 0 1112 8z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900">Analysis</h3>
                    <p class="mt-2 text-gray-600 text-sm">
                        Our machine learning models process the audio to detect tone, emotion, and sentiment.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-md p-6">
                    ...
                    <h3 class="text-lg font-bold text-gray-900">Get Instant Results</h3>
                    <p class="mt-2 text-gray-600 text-sm">
                        Receive insights about emotional states like happiness, sadness, anger, and more.
                    </p>
                </div>
            </div>
        </main>
    ...
    <footer class="mt-16 text-sm text-gray-500">
        © {{ date('Y') }} Voice Sentiment Analysis. All rights reserved.
    </footer>
